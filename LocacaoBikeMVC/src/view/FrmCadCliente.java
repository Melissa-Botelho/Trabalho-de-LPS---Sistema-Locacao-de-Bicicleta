...
public final class FrmCadCliente extends javax.swing.JFrame {
        ...
        if(tblcliente.getSelectedRow()!= -1){
           ...
           preencheFormulario();
            ...
            if(JOptionPane.showConfirmDialog(rootPane,"Deseja excluir o(a):" + cliente.getNome(),"Locacao de Bicicletas",JOptionPane.YES_NO_OPTION)== 0){
                ControllerCliente.delete(cliente.getIdCliente());
                TableCliente();
    ...
    public void preencheFormulario() {
        ...
        btnTel.setText(cliente.getTelefone());
        edtIdade.setText(""+cliente.getIdade());
    ...
    public void salvarCliente(){
            ...
            if (cbxSexo.getSelectedIndex() == 1)
                cliente.setSexo('F');
            if (tipoEdicao == 'N')     
                ControllerCliente.insert(cliente);
            else if (tipoEdicao == 'E') 
                ControllerCliente.update(cliente);       
    }
    ...
    public void TableCliente() {
        ...
        for(int i=0; i<arrayCliente.size(); i++){
                Object [] linha = {arrayCliente.get(i).getIdCliente(), arrayCliente.get(i).getNome(),arrayCliente.get(i).getIdade(),arrayCliente.get(i).getSexo(), arrayCliente.get(i).getCpf(), arrayCliente.get(i).getTelefone(), arrayCliente.get(i).getEmail(), arrayCliente.get(i).getEndereco()};
                model.addRow(linha);
            }
