...
public class FrmCadBicicleta extends javax.swing.JFrame {
     ...
     */
    private ArrayList<Object []> arrayBicicleta = new ArrayList();
    ...
    public Object [] buscarBicicleta (String modelo){
        for (int i =0; i<arrayBicicleta.size(); i++){
           if(arrayBicicleta.get(i)[2].equals(modelo)){
     ...
     public void preencheFormulario(){
        edtTam.setText(String.valueOf(bicicleta[3]));
        edtNome.setText((String)bicicleta[1]);
        edtModelo.setText((String)bicicleta[2]);
        edtTemp.setText(String.valueOf(bicicleta[4]));
        edtCor.setText((String)bicicleta[5]);
        edtTipo.setText((String)bicicleta[6]); 
        edtLoca.setText(String.valueOf(bicicleta[7]));
     }
    
    public void salvarBicicleta(){        
        if(tipoEdicao == 'N')  
            ControllerBicicleta.insert(edtNome.getText(),edtModelo.getText(),Float.parseFloat(edtTam.getText()),Float.parseFloat(edtTemp.getText()),edtCor.getText(),edtTipo.getText(),Float.parseFloat(edtLoca.getText()));
        else if(tipoEdicao == 'E')
            ControllerBicicleta.update(edtNome.getText(),edtModelo.getText(),Float.parseFloat(edtTam.getText()),Float.parseFloat(edtTemp.getText()),edtCor.getText(),edtTipo.getText(),Float.parseFloat(edtLoca.getText()),(int)bicicleta[0]);
    }
   
    public final void carregarBicicleta(){
        String [] colunas = {"ID","Nome", "Modelo", "Tamanho", "Tempo de Uso", "Valor da Locacao","Cor","Tipo do Pneu"};
        DefaultTableModel modelo = new DefaultTableModel(colunas, 0);
        arrayBicicleta = ControllerBicicleta.select();
        for(int i=0; i<arrayBicicleta.size(); i++){
                Object [] linha = {(int)arrayBicicleta.get(i)[0], (String)arrayBicicleta.get(i)[1], (String)arrayBicicleta.get(i)[2],(float)arrayBicicleta.get(i)[3],(float)arrayBicicleta.get(i)[4],(float)arrayBicicleta.get(i)[7], (String)arrayBicicleta.get(i)[5], (String)arrayBicicleta.get(i)[6]};
                modelo.addRow(linha);
            }
    ...
    public void excluir(){
        ...
        if(tblBike.getSelectedRow()!= -1){
           ...
           preencheFormulario();
            ativaForm(false);
            if(JOptionPane.showConfirmDialog(rootPane,"Deseja excluir o(a):" + (String)bicicleta[2],"Locacao de Bicicletas",JOptionPane.YES_NO_OPTION)== 0){
                ControllerBicicleta.delete((int)bicicleta[0]);
                carregarBicicleta();
    ...
    private void btnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultaActionPerformed
        ...
        try {
            ...
            Logger.getLogger(FrmCadBicicleta.class.getName()).log(Level.SEVERE, null, ex);
        }
